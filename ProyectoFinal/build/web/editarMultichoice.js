  ...
  render() {
    ...
    return (
      ...
      <Paper className={classes.paper}>
        ...
        <form action = "EscribirPregunta" method = "post" className={classes.form} onSubmit={this.handleSubmit}>
...
const EdicionMultichoice = withStyles(styles)(Index);
ReactDOM.render(<EdicionMultichoice />, document.getElementById('root'));
