...
class Index extends React.Component {
  ...
  render() {
    ...
    <Paper className={classes.paper}>
        ...
        <br /> <br/>
        <form action = "EscribirExamen" method = "post" className={classes.form} onSubmit={this.handleSubmit}>
              ...
              <TableRow className={classes.row}>
                ...
                <CustomTableCell> 
                   <FormControlLabel
                    ...
                    />
                    <IconButton aria-label="Ver Pregunta" className={classes.margin} onClick = {() => window.location.replace("MostrarPregunta?pregunta="+row+"&examen="+this.state.idexamen)}> 
