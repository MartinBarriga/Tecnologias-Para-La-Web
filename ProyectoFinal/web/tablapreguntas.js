  ...
  leerjson(){
   ...
   eliminar = value => () =>{
    ...
    if (confirm('Estas seguro de borrar esta pregunta?')) {
       window.location.replace("EliminarPregunta?preguntaEliminada="+value)
    } 
  } 
          ...
          {this.state.preguntas.map(row => {
            return (
              <TableRow className={classes.row}>
                ...
                <CustomTableCell> 
                    <IconButton aria-label="Ver Pregunta" className={classes.margin} onClick = {() => window.location.replace("MostrarMC?pregunta="+row)}> 
                        <Icon className={classes.icon}>visibility</Icon> 
                    </IconButton>  
                    <IconButton aria-label="Editar Pregunta" className={classes.margin} onClick = {() => window.location.replace("EditarPregunta?pregunta="+row)}>  
