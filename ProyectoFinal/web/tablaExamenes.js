...
class Index extends React.Component {
  ...
  eliminar = value => () =>{
    ...
    if (confirm('Estas seguro de borrar este examen?')) {
       window.location.replace("EliminarExamen?examenEliminado="+value)
    } 
  } 
          ...
          {this.state.examenes.map(row => {
            return (
              <TableRow className={classes.row}>
                ...
                <CustomTableCell>
                    <IconButton aria-label="Evaluar Examen" className={classes.margin} onClick = {() => window.location.replace("EvaluarPregunta?examen="+row)}>
                        <Icon className={classes.icon}>check_circle</Icon>
                    </IconButton>
                    <IconButton aria-label="Editar Examen" className={classes.margin} onClick = {() => window.location.replace("EditarExamen?examen="+row)}>
